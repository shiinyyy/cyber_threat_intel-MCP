...
# def get_group_intel(group_name: str):
#     """
#     Fetches intelligence on a specific threat group from the MITRE ATT&CK dataset.

#     Args:
#         group_name: The name or a known alias of the threat group.

#     Returns:
#         A dictionary containing the group's details, associated campaigns,
#         and techniques, or None if the group is not found.
#     """
#     print("Connecting to MITRE ATT&CK server...")
#     try:
#         server = Server("https://attack-taxii.mitre.org/taxii2/")
...
#     print("Fetching Enterprise ATT&CK collection...")
#     collection = next(
#         (c for c in api_root.collections if c.title == "Enterprise ATT&CK"), None
#     )
#     if not collection:
...
#     all_objects = collection.get_objects()["objects"]
#     print(f"Fetched {len(all_objects)} objects.")

#     # Create a lookup for quick access to any object by its STIX ID
#     objects_by_id = {obj["id"]: obj for obj in all_objects}

#     # Searching threat group by name 
#     group_object = None
...
#     print(f"Group retrieved: {group_object.get('name')}")
    
#     # Identify relationships for techniques and campaigns
#     technique_ids = set()
#     campaign_ids = set()
...
#             if (
#                 obj.get("source_ref") == group_object.get("id")
#                 and obj.get("relationship_type") == "uses"
#                 and "attack-pattern" in obj.get("target_ref", "")
#             ):
#                 technique_ids.add(obj["target_ref"])
...
#             elif (
#                 obj.get("target_ref") == group_object.get("id")
#                 and obj.get("relationship_type") == "attributed-to"
#             ):
#                 campaign_ids.add(obj["source_ref"])
